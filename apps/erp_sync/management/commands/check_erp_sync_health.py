"""
Management command para verificar a saúde da sincronização ERP.

Uso:
    python manage.py check_erp_sync_health
    python manage.py check_erp_sync_health --pending-hours 48
"""
...
class Command(BaseCommand):
    help = "Verifica saúde da sincronização ERP e alerta sobre pedidos com erro persistente"
